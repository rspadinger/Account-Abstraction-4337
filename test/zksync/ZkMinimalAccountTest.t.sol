...
contract ZkMinimalAccountTest is Test, ZkSyncChainChecker {
    ...
    function setUp() public {
        ...
        //tests will only be run locally => cheatcodes dont work very well on zksync => transfer ownership to first Anvil account
    ...
    function testZkValidateTransaction() public onlyZkSync {
        ...
        // Act
        //@note in zksync, the caller of validateTxn is alaways the Bootloader
